...
<?php $this->view('layout/navbar')?>
    ...
    <div class="container shadow rounded mx-auto p-4">
        ...
        <div class="card-group justify-content-center">
            <form method="post">
                <h3>Edit preseason</h3>
                <input type="text" class="form-control" value="<?=$row->school?>" name="school" placeholder="New preseason">
                <button type="submit" value="" class="btn btn-primary float-start mt-3">Create</button>
